...
class TestSubstituteView(TestCase):
    ...
    def test_get_subsitute_with_product_with_none_substitute_render_error_message(self):
        assert "Vous avez déjà le meilleur produit." in smart_str(self.response.content)
